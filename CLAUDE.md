...
**Organ:** ORGAN-V (Public Process) | **Tier:** standard | **Status:** LOCAL
**Org:** `organvm-v-logos` | **Repo:** `analytics-engine`

### Edges
- **Produces** → `ORGAN-V`: engagement-metrics
- **Produces** → `ORGAN-IV`: system-engagement-report
- **Produces** → `ORGAN-V`: analytics-dashboard
- **Consumes** ← `{'organ': 'EXTERNAL', 'repo': 'goatcounter.com'}`: goatcounter-api
- **Consumes** ← `{'organ': 'ALL', 'repo': '*'}`: github-activity

### Siblings in Public Process
`public-process`, `.github`, `editorial-standards`, `essay-pipeline`, `reading-observatory`
...
Run: `organvm ecosystem show analytics-engine` | `organvm ecosystem validate --organ V`
